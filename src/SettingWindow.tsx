...
export default function SettingWindow(props: Props) {
  ...
  const handleRepliesTokensSliderChange = (
    event: Event,
  ...
  const handleMaxContextSliderChange = (
    event: Event,
    newValue: number | number[],
    activeThumb: number
  ) => {
  ...
  return (
    <Dialog open={props.open} onClose={onCancel} fullWidth>
      ...
      <DialogContent>
        ...
        <FormControl
          sx={{ flexDirection: 'row', alignItems: 'center', paddingTop: 1, paddingBottom: 1 }}
        >
          ...
          <AccordionDetails>
                ...
                <Slider
                  ...
                  marks={[
                    ...
                    },
                    {
                      value: 0.8,
                      label: (
                        <Chip size="small" icon={<LightbulbCircleIcon />} label={t('creative')} />
                      )
                    }
                  ]}
                />
            ...
            <FormGroup>
              <FormControlLabel
                ...
                onChange={(e, checked) =>
                  setSettingsEdit({ ...settingsEdit, showModelName: checked })
                }
              />
            </FormGroup>
          </AccordionDetails>
