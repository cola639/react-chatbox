  ...
  return (
    <Dialog open={props.open} onClose={props.close} fullWidth>
      ...
      <DialogContent>
        <Box sx={{ textAlign: 'center', padding: '0 20px' }}>
          ...
          <span>
            <Trans
              ...
              components={[
                <a
                  href={`https://chatboxapp.xyz/redirect_app/author/${props.lang}`}
                  target="_blank"
                ></a>
              ]}
            />
        ...
        <Stack spacing={2} direction="row" sx={{ justifyContent: 'center', marginTop: '10px' }}>
          <Badge color="primary" variant="dot" invisible={false}>
            <Button
              variant="outlined"
              onClick={() =>
                api.openLink(`https://chatboxapp.xyz/redirect_app/check_update/${props.lang}`)
              }
            >
              {t('Check Update')}
            </Button>
          ...
          <Button
            variant="outlined"
            onClick={() =>
              api.openLink(`https://chatboxapp.xyz/redirect_app/homepage/${props.lang}`)
            }
          >
            {t('Homepage')}
          </Button>
          <Button
            variant="outlined"
            onClick={() =>
              api.openLink(`https://chatboxapp.xyz/redirect_app/feedback/${props.lang}`)
            }
          >
            {t('Feedback')}
          </Button>
          <Button
            variant="outlined"
            onClick={() =>
              api.openLink(`https://chatboxapp.xyz/redirect_app/roadmap/${props.lang}`)
            }
          >
            {t('Roadmap')}
          </Button>
        ...
        <Paper
          elevation={3}
          sx={{ padding: '10px 10px 5px 10px', backgroundColor: 'paper', marginTop: '30px' }}
        >
          ...
          <Stack spacing={2} direction="row">
            <Button
              variant="text"
              onClick={() =>
                api.openLink(`https://chatboxapp.xyz/redirect_app/donate/${props.lang}`)
              }
            >
              {t('Donate')}
            </Button>
            <Button
              variant="text"
              onClick={() =>
                api.openLink(`https://chatboxapp.xyz/redirect_app/become_sponsor/${props.lang}`)
              }
            >
